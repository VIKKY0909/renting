-- Enhanced User Management with Roles and Super Admin
-- This script adds user roles, super admin functionality, and fixes profile issues
...
-- Create user_activity table for real recent activity tracking
...
-- Update products table to allow admin direct listing without approval
...
INSERT INTO public.admin_notifications (type, title, message, priority) VALUES 
    ('system_alert', 'Enhanced User Management', 'User roles, activity tracking, and super admin functionality have been added.', 'high');
